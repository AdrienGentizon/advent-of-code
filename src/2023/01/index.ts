...
function parseStringAsNumber(str: string): number {
  if (str.length === 1) return parseInt(str)
  return numbersAsStrings[str as keyof typeof numbersAsStrings]
}
...
export function compute() {
  ...
  for (const input of inputs.split('\n')) {
    ...
    const firstNumber = parseStringAsNumber(matches[0][0])
